...
export const agendaService = {
    async getAgendas(eventId, token, page = 1, size = 20, search = '') {
        try {
            ...
            const response = await fetch(`${BASE_URL}/${eventId}/agenda/list/?${queryParams}`, {
                method: 'GET',
    ...
    async createAgenda(eventId, token, formData) {
        try {
            ...
            const response = await fetch(`${BASE_URL}/${eventId}/agenda/create/`, {
                method: 'POST',
                headers: headers,
                body: formData
            });
    ...
    async updateAgenda(eventId, agendaId, token, formData) {
        try {
            ...
            const response = await fetch(`${BASE_URL}/${eventId}/agenda/${agendaId}/edit/`, {
                method: 'PATCH',
                headers: headers,
                body: formData
            });
    ...
    async deleteAgenda(eventId, agendaId, token) {
        ...
        try {
            const response = await fetch(`${BASE_URL}/${eventId}/agenda/${agendaId}/delete/`, {
                method: 'DELETE',
                headers: getHeaders(token)
            });
