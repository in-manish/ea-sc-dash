...
import { FormField, SettingsToggleRow, ToggleSwitch, getInputClass } from './components/SharedComponents';
...
const ComplimentaryInviteeLinkItem = ({
    ...
    return (
        <div className={`bg-bg-secondary border rounded-lg p-5 ${isEnabled ? 'border-border' : 'border-dashed border-slate-300'}`}>
            <div className="flex justify-between items-start mb-5">
                <div className="flex items-center gap-2">
                    ...
                    {!isEnabled && (
                        <span className="px-2 py-0.5 bg-slate-200 rounded text-[10px] font-bold text-text-tertiary uppercase tracking-tighter">
                            Inactive
                        </span>
                    )}
                </div>
                <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <ToggleSwitch
                            ...
                            checked={isEnabled}
                            isModified={isInviteeLinkModified(index, 'is_active')}
                            onChange={(e) => handleInviteeLinkChange(index, 'is_active', e.target.checked)}
                        />
                    </div>
                </div>
            </div>
            ...
            <div className={isEnabled ? '' : 'opacity-50'}>
                ...
                <div className="mt-4">
                    <SettingsToggleRow
                        title="Complementary"
                        description="Mark this link as complementary access."
